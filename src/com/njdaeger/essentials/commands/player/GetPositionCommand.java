...
public class GetPositionCommand extends BukkitCommand{
	...
	public GetPositionCommand() {
		...
		this.setPermission(Permission.ESS_POSITION.getPermission());
		this.setPermission(Permission.ESS_POSITION_OTHER.getPermission());
	...
	public boolean execute(CommandSender sndr, String label, String[] args) {
		if (sndr instanceof Player) {
			...
			if (args.length == 1) {
				if (sndr.hasPermission(Permission.ESS_POSITION_OTHER.getPermission()) || sndr.hasPermission(Permission.ESS_ALL.getPermission()) || sndr.isOp()) {
